...
class Misc(commands.Cog):
    ...
    async def backup(self, ctx):
        ...
        await ctx.send(
            embed=discord.Embed(
                description="Backup taken", color=discord.Color.green()
            )
        )
    ...
    async def scrape_(self, ctx):
        ...
        await ctx.send(
            embed=discord.Embed(
                description="Scraping problem author list",
    ...
    async def botinfo(self, ctx):
        ...
        embed.add_field(
            name="Matches played", value=f"**{matches}**", inline=True
        )
        embed.add_field(
            name="Rounds played", value=f"**{rounds}**", inline=True
        )
        embed.add_field(name="Servers", value=f"**{guilds}**", inline=True)
        embed.add_field(
            name="Uptime", value=f"**{timeez(uptime_)}**", inline=True
        )
        embed.add_field(
            name="Memory usage",
